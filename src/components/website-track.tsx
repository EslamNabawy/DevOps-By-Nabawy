      ...
      <div className="lg:sticky lg:top-24 lg:self-start">
        <details className="rounded-2xl border border-border bg-card p-4 shadow-card lg:hidden">
          <summary className="flex cursor-pointer items-center gap-2 text-xs font-bold uppercase text-muted-foreground">
            <ListTree className="h-4 w-4" /> Track contents · {outline.length}
          </summary>
        ...
        <nav aria-label="Track contents" className="hidden lg:block">
          <p className="mb-3 font-mono text-xs font-bold text-primary">MAP</p>
          <ol className="grid gap-2.5 border-l-2 border-border pl-4">
            {outline.map((item) => (
              <li key={item.n} className="text-sm leading-6">
          ...
          <div>
            <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-card">
              ...
              <button
                ...
                className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-foreground/60 p-6 text-center transition-colors hover:bg-foreground/55"
              >
                <span className="grid h-12 w-12 place-items-center rounded-full bg-primary text-primary-foreground shadow-card-hover">
                  <Play className="ml-0.5 h-6 w-6" />
                </span>
                <span className="font-display max-w-md text-lg font-bold text-white sm:text-xl">
