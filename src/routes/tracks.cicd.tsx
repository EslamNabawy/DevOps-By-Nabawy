      ...
      <section className="border-b border-border bg-hero">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-8 sm:px-6 sm:py-8">
          ...
          <div
            ...
            className="mt-4 flex w-full gap-1 rounded-2xl border border-border bg-muted/60 p-1 sm:mt-5 sm:inline-flex sm:w-auto sm:gap-0 sm:rounded-full"
          >
            {tabs.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex h-9 min-w-0 flex-1 items-center justify-center gap-1.5 rounded-xl px-2 text-xs font-semibold transition-colors sm:h-10 sm:flex-none sm:gap-2 sm:rounded-full sm:px-4 sm:text-sm ${
                    active
                ...
                >
                  ...
                  <span className="hidden shrink-0 rounded-full bg-primary/10 px-2 py-0.5 font-mono text-[10px] font-bold text-primary min-[420px]:inline-flex sm:inline-flex">
                    {item.hint}
                  </span>
                </button>
              );
        ...
        <section className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-8 sm:px-6 sm:py-8 sm:py-10">
          {site ? (
            <div className="mb-6 flex flex-col gap-3 rounded-2xl border border-border bg-card p-5 shadow-card sm:flex-row sm:items-center">
              <span className="grid h-9 w-9 shrink-0 sm:h-10 sm:w-10 place-items-center rounded-xl bg-secondary-accent/10 text-secondary-accent">
